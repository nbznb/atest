...
- For bilingual mode: interleave English and Chinese paragraph by paragraph.
  After each source's English summary, place the Chinese translation directly below
  (separated by a blank line), then move to the next source. Same for podcasts.
